...
func (m *MockHostedStorageStore) ListUsageBytesBySpace(ctx context.Context, orgID string, spaceIDs []string) (map[string]int64, error) {
	args := m.Called(ctx, orgID, spaceIDs)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
