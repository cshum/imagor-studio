  ...
  return (
    <div className='space-y-6'>
          ...
          return (
            <Card key={member.userId}>
              <CardContent className='flex items-center justify-between gap-4 py-4'>
                ...
                <DropdownMenu
                  open={openMenuMemberId === menuId}
                  onOpenChange={(open) => setOpenMenuMemberId(open ? menuId : null)}
                >
      ...
      >
        <ResponsiveDialogHeader>
          <ResponsiveDialogTitle>
            {t('pages.spaceSettings.members.removeDialogTitle')}
          </ResponsiveDialogTitle>
          <ResponsiveDialogDescription>
      ...
      <ResponsiveDialog open={leaveDialogOpen} onOpenChange={setLeaveDialogOpen}>
        <ResponsiveDialogHeader>
          <ResponsiveDialogTitle>
            {t('pages.spaceSettings.members.leaveDialogTitle')}
          </ResponsiveDialogTitle>
          <ResponsiveDialogDescription>
