...
// Shows "••••••••" + an "Update" button when hidden.
// Shows a controlled Input + "Cancel" button when revealed.
// Used wherever a write-only credential should be editable but never pre-filled.
