---
sidebar_position: 4
description: Configure imagor inside Imagor Studio, including signing, caching, processing limits, and links to the upstream imagor docs and benchmarks.
keywords:
  - imagor studio imagor configuration
  - imagor docs
  - imagor benchmarks
  - imagor signing
  - imagor performance
...
For the complete upstream reference, see the [imagor docs](https://docs.imagor.net/). For measured performance comparisons, see [imagor benchmarks](https://docs.imagor.net/benchmarks).
...
For measured benchmark results and methodology, see [imagor benchmarks](https://docs.imagor.net/benchmarks).
...
For complete URL syntax and filter documentation, see the [imagor documentation](https://docs.imagor.net/).
...
- [imagor Documentation](https://docs.imagor.net/) - Complete imagor reference
